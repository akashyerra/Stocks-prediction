    ...
    new (class extends class {
      ...
      _replaceScript(e) {
        const {
          ...
          c = n.parentNode,
          h = n.nonce || n.getAttribute("nonce"),
          d = (function (t) {
        ...
        h && b.setAttribute("nonce", h), this.iframeContainer.appendChild(b);
        const v = this.hasCopyright() && w ? `calc(${w} - 32px)` : w,
          S = location.hostname,
        ...
        (this.settings.utm_source = S),
          ...
          this._updateCopyrightHrefParams(S, C, _);
        const T =
            this.settings.iframeTitle ||
            `${this.widgetId.replace("-", " ")} TradingView widget`,
          k = this.settings.iframeLang || "en";
        this.iframe = this._createIframe(v, y, o, i, l, T, k);
        const A = this._iframeSrcHost(o, i);
        this._addCSPErrorListener(A), h && this.iframe.setAttribute("nonce", h);
        const x = this.iframeContainer.querySelector(
          ".tradingview-widget-container__widget"
        );
        if (
          (x
            ? ((0, t.ensureNotNull)(x.parentElement).replaceChild(
                this.iframe,
                x
              ),
              null == n || n.remove())
            ...
            ? (this.iframeContainer.appendChild(this.iframe),
              null == n || n.remove())
            : (this.iframeContainer.appendChild(this.iframe),
              c.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(n))),
      ...
      _createIframe(t, e, i, r, o, n, s) {
        ...
        return (
          this._setSettingsQueryString(l),
          this._setHashString(l, o),
      ...
      _tryFixCSPIssueWithFallback(t) {
        ...
        e &&
          this.iframe.setAttribute(
            "src",
            e.replace(t, "https://s.tradingview.com")
          );
      }
